...
Comets are transient presentation accents rather than selectable scientific
bodies. Use a compact animated amber-white energy nucleus with procedural
flame-like surface breakup and a soft-edged white-to-amber additive trail. The
result may evoke a moving flame ball at gameplay distance, but must remain
exposure-safe and subordinate to the Sun, selected-body reticle, and orbit
guides. Avoid opaque smoke, sparks, collision effects, or an oversized
terrestrial meteor silhouette.

The nucleus and trail scale are deliberately illustrative. Their path is a
bounded fly-through generated by the presentation system, not literal
combustion or a claim about a named comet, a date-specific ephemeris, or a
physically solved tail direction.
The material, shader, prefab, and runtime behavior are project-authored and add
no third-party asset or license.
