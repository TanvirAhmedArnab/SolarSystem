...
namespace Tanvir.SolarSystem.Editor.Import
{
    ...
    internal sealed class SolarSystemSlice2Content
    {
        ...
        internal CelestialLayerVisualDefinition MarsLayerDefinition { get; set; }
        internal Material MarsAtmosphereMaterial { get; set; }
        internal CelestialLayerVisualDefinition TitanLayerDefinition { get; set; }
        internal Material TitanHazeMaterial { get; set; }
        ...
        internal IceGiantVisualDefinition UranusVisualDefinition { get; set; }
        internal Material UranusAtmosphereMaterial { get; set; }
        internal IceGiantVisualDefinition NeptuneVisualDefinition { get; set; }
